...
export default function Index() {
    ...
    return (
        <div className='flex flex-col   relative bg-tchatbox-semi600 h-screen w-full'>
            ...
            <div
                className='z-10 bg-tchatbox-semi600 w-full sm:w-4/6 md:w-4/6 lg:w-4/6 xl:w-2/5 rounded-md p-5 m-12 flex flex-row mx-auto mt-16'>
                <div className='flex flex-col w-full'>
                   ...
                   focus:ring-2 focus:ring-blue-400 bg-tchatbox-transparentBlack2 text-white
                    w-full rounded py-1 px-2'
                                        ...
                                        name='password'
                                        type='password'/>
                                    <a href='#' className='text-xs text-tchatbox-textLink hover:underline'>
                    ...
                    <div className='mt-2'>
                        ...
                        <Link to='/register' className='text-xs text-tchatbox-textLink hover:underline'>
                            Register
                        </Link>
                    </div>
                </div>
