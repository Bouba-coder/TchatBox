...
export default function Friends({
    ...
    return (
        <div
            className='flex pt-3 px-2 border-b-1 border-tchatbox-900 w-full pb-2 bg-tchatbox-selectMuted'>
            <h6 className='text-white font-semibold'>
                <FriendsIcon
                    className='w-6 h-6 mr-3 inline-block text-tchatbox-sideBarChannels'/>
                Friends
            </h6>
            <ul className='flex ml-6'>
                ...
                <li className='ml-8 flex justify-center items-center'>
                    ...
                    </a>
                    {
                        !!pendingRequests && (
                            <span
                                className='rounded-full h-5 w-5 flex items-center justify-center ml-1 bg-tchatbox-redNotif text-white text-xs'>
                                {pendingRequests}
                            </span>
                        )
                    }
                ...
                <li className='ml-8'>
                    <button
                        ...
                        className={classNames('text-white text-sm p-px px-2 rounded-md focus:outline-none', {
