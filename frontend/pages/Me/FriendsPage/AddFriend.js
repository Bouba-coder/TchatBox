            ...
            <div className='px-6 py-4'>
                ...
                <div
                    className={classNames(
                        'w-full mt-4 bg-tchatbox-deprecatedTextInput border-1 border-tchatbox-deprecate' +
                                'dTextInputBorder w-full rounded-lg',
                        {
                    ...
                    <form className='flex justify-between'>
                        <input
                            ...
                            maxLength='37'
                            className={classNames(
                                'w-full text-tchatbox-100 p-3 bg-tchatbox-deprecatedTextInput placeholder-tchat' +
                                'box-200 focus:outline-none leading-normal text-base'
                            )}/>
                        <button
                            type='button'
                            disabled={!!input === false}
                            onClick={handleSendFriendRequest}
                            className={classNames('text-xs rounded-md text-white px-0 w-56 m-2', {
