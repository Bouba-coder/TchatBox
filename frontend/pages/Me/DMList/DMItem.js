    ...
    return (
        <li
            className={classNames(
                'w-full px-1 py-1 hover:bg-tchatbox-itemHover rounded cursor-pointer border-t-1' +
                        ' border-tchatbox-backgroundModifierAccent',
                ...
                <div className='flex'>
                    <div className='relative flex items-center justify-center'>
                        <div
                            ...
                            friendObject(user, room).color} text-white hover:text-tchatbox-100 rounded-full`}>
                ...
                <div className='flex'>
                    {
                        showCloseButton && (
                            <button
                                className='flex items-center justify-end p-2 rounded-full focus:outline-none z-10'>
                                {
                                    isLoading
